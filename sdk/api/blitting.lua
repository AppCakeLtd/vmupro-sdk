...
--- @usage vmupro.graphics.blitBufferAt(sprite_buffer, 50, 50, 32, 32)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferAt(buffer, x, y, width, height) end
...
--- @usage vmupro.graphics.blitTile(atlas_buffer, 100, 100, 64, 0, 32, 32, 256)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitTile(buffer, x, y, atlas_src_x, atlas_src_y, width, height, tilemap_width) end

--- @brief Blit a buffer using a color palette
--- @param buffer userdata Indexed color buffer
--- @param palette userdata Color palette
--- @usage vmupro.graphics.blitBufferWithPalette(indexed_buffer, color_palette)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferWithPalette(buffer, palette) end
...
--- @usage vmupro.graphics.blitTilePattern(tile_buffer, 16, 16, 0, 0, 240, 240)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitTilePattern(tile_buffer, tile_width, tile_height, pattern_x, pattern_y, pattern_width, pattern_height) end
...
--- @usage vmupro.graphics.blitBufferTransparent(sprite_buffer, 50, 50, 32, 32, 0xF81F, 0)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferTransparent(buffer, x, y, width, height, transparent_color, flags) end
...
--- @usage vmupro.graphics.blitBufferBlended(sprite_buffer, 50, 50, 32, 32, 128)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferBlended(buffer, x, y, width, height, alpha_level) end
...
--- @usage vmupro.graphics.blitBufferDithered(sprite_buffer, 50, 50, 32, 32, 64)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferDithered(buffer, x, y, width, height, dither_strength) end
...
--- @usage vmupro.graphics.blitBufferFlipped(sprite_buffer, 50, 50, 32, 32, 1)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferFlipped(buffer, x, y, width, height, flags) end
...
--- @usage vmupro.graphics.blitBufferFixedAlpha(sprite_buffer, 50, 50, 32, 32, 192)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferFixedAlpha(buffer, x, y, width, height, alpha) end
...
--- @param width number Width to blit
--- @param height number Height to blit
--- @usage vmupro.graphics.blitBufferMasked(sprite_buffer, mask_buffer, 50, 50, 32, 32)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferMasked(buffer, mask, x, y, width, height) end
...
--- @usage vmupro.graphics.blitBufferScaled(sprite_buffer, 50, 50, 32, 32, 64, 64)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferScaled(buffer, x, y, src_width, src_height, dest_width, dest_height) end
...
--- @usage vmupro.graphics.blitBufferRotated90(sprite_buffer, 50, 50, 32, 32, 1)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferRotated90(buffer, x, y, width, height, rotation_steps) end
...
--- @usage vmupro.graphics.blitBufferRotatedPrecise(sprite_buffer, 50, 50, 32, 32, 45)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferRotatedPrecise(buffer, x, y, width, height, angle) end
...
--- @usage vmupro.graphics.blitScrollingBackground(bg_buffer, scroll_x, scroll_y, 240, 240)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitScrollingBackground(buffer, scroll_x, scroll_y, buffer_width, buffer_height) end
...
--- @usage vmupro.graphics.blitInfiniteScrollingBackground(tile_buffer, scroll_x, scroll_y, 32, 32)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitInfiniteScrollingBackground(buffer, scroll_x, scroll_y, tile_width, tile_height) end
...
--- @param buffer_width number Buffer width
--- @param buffer_height number Buffer height
--- @usage vmupro.graphics.blitParallaxBackground(bg_buffer, scroll_x, scroll_y, 0.5, 480, 240)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitParallaxBackground(buffer, scroll_x, scroll_y, parallax_factor, buffer_width, buffer_height) end
...
--- @param buffer_width number Buffer width
--- @param buffer_height number Buffer height
--- @usage vmupro.graphics.blitLineScrollBackground(bg_buffer, line_offsets, 240, 240)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitLineScrollBackground(buffer, scroll_offsets, buffer_width, buffer_height) end
...
--- @param buffer_width number Buffer width
--- @param buffer_height number Buffer height
--- @usage vmupro.graphics.blitColumnScrollBackground(bg_buffer, column_offsets, 240, 240)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitColumnScrollBackground(buffer, scroll_offsets, buffer_width, buffer_height) end
...
--- @usage vmupro.graphics.blitBufferMosaic(sprite_buffer, 50, 50, 32, 32, 4)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferMosaic(buffer, x, y, width, height, mosaic_size) end
...
--- @usage vmupro.graphics.blitBufferBlurred(sprite_buffer, 50, 50, 32, 32, 2)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferBlurred(buffer, x, y, width, height, blur_radius) end

--- @brief Apply mosaic effect to the entire screen
--- @param mosaic_size number Mosaic block size
--- @usage vmupro.graphics.applyMosaicToScreen(8)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.applyMosaicToScreen(mosaic_size) end
...
--- @usage vmupro.graphics.blitBufferShadowHighlight(sprite_buffer, 50, 50, 32, 32, 0x0000, 0xFFFF)
--- @note This is a stub definition for IDE support only.
---       Actual implementation is provided by VMU Pro firmware at runtime.
function vmupro.graphics.blitBufferShadowHighlight(buffer, x, y, width, height, shadow_color, highlight_color) end